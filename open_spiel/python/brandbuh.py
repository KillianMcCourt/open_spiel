...
_GAME_TYPE = pyspiel.GameType(
    short_name="python_brandbuh",
    long_name="Python Brandbuh",
...
class BrandbuhGame(pyspiel.Game):
  """A Python version of the Brandbuh game."""
...
class BrandbuhState(pyspiel.State):
  """A python version of the Brandbuh state."""
...
pyspiel.register_game(_GAME_TYPE, BrandbuhGame)
