...
from open_spiel.python.games import brandbuh
...
class BrandbuhTest(absltest.TestCase):
  ...
  def test_game_from_cc(self):
    ...
    game = pyspiel.load_game("python_brandbuh")
  ...
  def test_playthoughs_consistent(self):
    ...
    cc_playthrough = os.path.join(path, "brandbuh.txt")
    py_playthrough = os.path.join(path, "python_brandbuh.txt")
    ...
    self.assertEqual(
        diffs, {
            "- game: brandbuh\n",
            "+ game: python_brandbuh\n",
            '- GameType.long_name = "Tic Tac Toe"\n',
            '+ GameType.long_name = "Python Brandbuh"\n',
            '- GameType.short_name = "brandbuh"\n',
            '+ GameType.short_name = "python_brandbuh"\n',
            '- ToString() = "brandbuh()"\n',
            '+ ToString() = "python_brandbuh()"\n',
            "- CurrentPlayer() = -4\n",
  ...
  def test_consistent(self):
    ...
    py_game = pyspiel.load_game("python_brandbuh")
    cc_game = pyspiel.load_game("brandbuh")
